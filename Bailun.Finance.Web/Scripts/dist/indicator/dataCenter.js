(function () {
    ...
    function renderDataList(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            str += '<tr><td><span data-type="0" data-date="' + data[i].Valuetime + '">' + data[i].Itemname + '</span></td>' + '<td class="time">' + data[i].Valuetime + '</td>' + '<td><span data-type="1" data-date="' + data[i].Valuetime + '">' + data[i].Frontvalue + '</span></td>' + '<td><span data-type="2" data-date="' + data[i].Valuetime + '">' + data[i].Currentvalue + '</span></td>' + '<td><span data-type="3" data-date="' + data[i].Valuetime + '">' + data[i].Predvalue + '</span></td>' + '</tr>';
        }
    ...
    function newItemStyle(index) {
        var itemStyle = {
            normal: {
                color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{ offset: 0, color: barColorStart[index] }, { offset: 1, color: barColorEnd[index] }])
            }
        };
        return itemStyle;
    }
        ...
        for (var i = 0; i < visualMap.length; i++) {
            if (visualMap[i].show) {
                ...
                var newSeriesItem = {
                    ...
                    itemStyle: {
                        normal: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{ offset: 0, color: barColorStart[i] }, { offset: 1, color: barColorEnd[i] }])
                        }
                    }
                };

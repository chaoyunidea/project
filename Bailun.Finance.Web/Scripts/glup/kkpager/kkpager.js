...
if (!document.getElementById('kkpagecss'))
{
    ...
    js.href = '/Scripts/1.0.0/glup/kkpager/kkpager_blue.min.css';
    js.id = 'kkpagecss';
    js.rel = 'stylesheet';
...
//    pagerid: "kkpager1", total: 4, pno: 4, isShowCurrPage: true, mode: 'link', click: function (n) { this.selectPage(n); return false; }
//}, true);
...
//a.generPageHtml({
//    type: "a", pagerid: "kkpager1", total: 4, pno: 4, isShowCurrPage: true, mode: 'click', click: function (n) { this.selectPage(n); return false; }
//}, true);
//b.generPageHtml({ type: "b", pagerid: "kkpager2", total: 5, pno: 5, isShowCurrPage: false, mode: 'click', click: function (n) { this.selectPage(n); return false; } }, true);
...
var kkpagerNews = {
    ...
    _getHandlerStr: function (n) {
        if (this.mode == 'click') {
            return 'href="' + this.getHref(n) + '" onclick="return kkpagerNews._clickHandler(' + n + ',{total:' + this.total + ',pagerid:\'' + this.pagerid + '\'})"';
        }
        //link模式，也是默认的
        return 'href="' + this.getLink(n) + '"';
    },
...
//kkpagerNews.generPageHtml({
//    pagerid: "kkpager" + pagerId,
//    total: pageCont,
//    pno: pageIndex,
...
//        $(".indexgold_llms").each(function () {
//            var pager2 = $(this).data("id");
//            debugger;
//            if (pager == pager2) {
//                var pageSize = $(this).data("page");
//                pagerIdAjax(pageSize, n, pager);
//            }

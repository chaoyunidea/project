...
*/(function (global, factory) {
    ...
    */
    ...
    /* istanbul ignore next */
    avalon._nativeBind = (!!window.addEventListener) ? function (el, type, fn, capture) {
        el.addEventListener(type, fn, !!capture);
    } : function (el, type, fn) {
        el.attachEvent('on' + type, fn);
    };
    /* istanbul ignore next */
    avalon._nativeUnBind = (!!window.addEventListener) ? function (el, type, fn, a) {

...
(function () {
    ...
    function J() {
        ...
        for (var B = 0; B < $.length; B++) {
            ...
            _ = _.substr(0, _.toLowerCase().indexOf("wdatepicker.min.js"));
            A = _.lastIndexOf("/");
            if (A > 0)
                _ = _.substring(0, A + 1);
            if (_)
    ...
    function I(G, _) {
        ...
        if (!$dp.dd || G.eCont || ($dp.dd && (G.getRealLang().name != $dp.dd.lang || G.skin != $dp.dd.skin))) {
            if (G.eCont)
                ...
                $dp.dd.setAttribute('className','WdatePicker');

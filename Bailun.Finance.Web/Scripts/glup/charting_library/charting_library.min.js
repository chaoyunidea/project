        ...
        for (; h < g; h++)
            if (null != (a = arguments[h]))
                for (b in a)
                    c = f[b],
                    e = a[b],
                    f !== e && (l && e && (m(e) || (d = Array.isArray(e))) ? (d ? (d = !1,
                    c = c && Array.isArray(c) ? c : []) : c = c && m(c) ? c : {},
                    f[b] = k(l, c, e)) : void 0 !== e && (f[b] = e));
        return f
    }
    function g(a) {
    ...
    if (!window.TradingView) {
        var n = {
          ...
          , d = {
              ...
              widget: function (a) {
                  this.ParentWindowCallback = a.ParentWindowCallback;
                  this.id = d.gId();
                  if (!a.datafeed)

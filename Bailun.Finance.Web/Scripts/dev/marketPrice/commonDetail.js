...
//$(function () {
    ...
    detailRefreshRender = function(data) {
        ...
        str += '<div class="title">' + nameHtml
            + '<div class="digital ' + (priceStatus(calcVal.priceExchange))
            + '"> <h2>' + data.CurrentPrice
            + '</h2>'
            + '<p>' + calcVal.priceExchange + '('
            + calcVal.priceLimit
            + ')</p> </div></div>'
            + '<dl class="compare">'
            + (productId == 1 || productId == 11 ? 
            ('<dd><p>今开</p><em>' + parseFloat(data.OpenPrice) + '</em></dd>'
            + '<dd><p>今日最高</p><em>' + parseFloat(data.HighPrice) + '</em></dd>'
            + '<dd><p>昨收</p><em>' + parseFloat(data.ClosePrice) + '</em></dd>'
            + '<dd><p>今日最低</p><em>' + parseFloat(data.LowPrice) + '</em></dd>')
            : ('<dd><p>今日最高</p><em>' + parseFloat(data.HighPrice) + '</em></dd>'
            + '<dd><p>今日最低</p><em>' + parseFloat(data.LowPrice) + '</em></dd>'))
            + '</dl>';               
